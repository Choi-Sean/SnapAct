...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    home: {
      ...
      layer0Unsupported: {
        ...
        body: 'On-device analysis isn\'t available on this device or app version. Continuing sends this photo to our server instead — free for medication, documents, and unrecognized photos; other categories may use tokens. Continue?',
        cancelButton: 'Cancel',
    ...
    permissions: {
      ...
      layer0UnsupportedBody: 'This device (or app version) can\'t run on-device analysis. Photos are analyzed on our server instead — the photo leaves your device for that analysis, and some categories may use tokens.',
  ...
  ko: {
    ...
    home: {
      ...
      layer0Unsupported: {
        title: '서버 분석으로 진행할까요?',
        body: '이 기기 또는 앱 버전에서는 온디바이스 분석을 사용할 수 없어요. 계속하면 사진이 서버로 전송돼요 — 복약·문서·미인식 사진은 무료지만, 다른 카테고리는 토큰이 쓰일 수 있어요. 계속할까요?',
        cancelButton: '취소',
        onceButton: '이번만 계속',
    ...
    permissions: {
      ...
      layer0UnsupportedBody: '이 기기(또는 앱 버전)에서는 온디바이스 분석을 사용할 수 없어요. 대신 서버에서 사진을 분석해요 — 그 분석을 위해 사진이 기기 밖으로 나가고, 카테고리에 따라 토큰이 쓰일 수 있어요.',
  ...
  es: {
    ...
    home: {
      ...
      layer0Unsupported: {
        ...
        body: 'El análisis en el dispositivo no está disponible en este dispositivo o versión de la app. Si continúas, la foto se enviará a nuestro servidor en su lugar — gratis para medicamentos, documentos y fotos no reconocidas; otras categorías pueden usar tokens. ¿Continuar?',
        cancelButton: 'Cancelar',
    ...
    permissions: {
      ...
      layer0UnsupportedBody: 'Este dispositivo (o versión de la app) no puede ejecutar el análisis en el dispositivo. Las fotos se analizan en nuestro servidor en su lugar — la foto sale de tu dispositivo para ese análisis, y algunas categorías pueden usar tokens.',
