...
export const dictionaries: Record<Locale, Dictionary> = {
  ...
  ja: {
    ...
    home: {
      ...
      medicationName: '薬名',
      medicationDosage: '用量',
      medicationFrequencyTemplate: '1日{n}回',
      medicationDurationTemplate: '{n}日間',
      medicationTimingBeforeMeal: '食前',
      medicationTimingAfterMeal: '食後',
      medicationTimingWithMeal: '食事と一緒に',
      medicationTimingUnspecified: '時間指定なし',
      saveToContacts: '連絡先に保存',
      saveToCalendar: 'カレンダーに保存',
      saveToReminder: '服薬リマインダーを設定',
      saveDoneTitle: '保存完了',
      saveContactDoneBody: '連絡先アプリに保存されました。',
      saveCalendarDoneBody: 'カレンダーに予定が追加されました。',
      saveReminderDoneBodyTemplate: '{n}日間、毎日の服薬リマインダーを設定しました。',
      saveFailTitle: '保存に失敗しました',
      timeConfirm: {
        title: 'リマインダー時刻の確認',
        subtitleMedication: '正確な服薬時刻が記載されていません。通知してほしい時刻を選んでください。',
        subtitleEvent: '写真から正確な時刻が見つかりませんでした。予定の時刻を選んでください。',
        doseLabelTemplate: '{n}回目',
    ...
    review: {
      ...
      demo: {
        ...
        contactNote: 'Snapsistのデモで作成された連絡先です。',
        mailSubjectDefault: 'Snapsistデモメール',
        mailBodyFormat: 'HTML形式（isHtml: true）',
        mailBodyContent: '<b>Snapsist</b>が自動入力したメール下書きです。',
        ...
        filesContentPrefix: 'Snapsistデモファイル\n作成日時: ',
        filesShareDialogTitle: 'Snapsistファイルを保存',
        filesDetail: 'ドキュメントディレクトリに保存されました',
        walletDescriptionDefault: 'Snapsistデモパス',
        walletShareDialogTitle: 'Apple Walletに追加',
        walletDetail: 'Apple Walletの共有シートが開きました',
        notificationTitleTemplate: 'Snapsist / {text}',
        notificationSubtitleDefault: 'デモ通知',
        notificationBody: 'この通知は全パラメータを実演するため、5秒後に届くよう予約されています。',
    ...
    batch: {
      ...
      categoryLabels: categoryLabels(['名刺', 'レシート', 'イベント', '書類', '服薬案内', '不明']),
      actionContact: '→ 連絡先',
  ...
  zh: {
    ...
    home: {
      ...
      medicationName: '药品名称',
      medicationDosage: '剂量',
      medicationFrequencyTemplate: '每天{n}次',
      medicationDurationTemplate: '共{n}天',
      medicationTimingBeforeMeal: '饭前',
      medicationTimingAfterMeal: '饭后',
      medicationTimingWithMeal: '随餐',
      medicationTimingUnspecified: '未指定时间',
      saveToContacts: '保存到通讯录',
      saveToCalendar: '保存到日历',
      saveToReminder: '设置服药提醒',
      saveDoneTitle: '保存成功',
      saveContactDoneBody: '已保存到通讯录应用。',
      saveCalendarDoneBody: '日程已添加到日历应用。',
      saveReminderDoneBodyTemplate: '已设置连续{n}天的每日服药提醒。',
      saveFailTitle: '保存失败',
      timeConfirm: {
        title: '确认提醒时间',
        subtitleMedication: '标签上没有确切的服药时间，请选择提醒时间。',
        subtitleEvent: '照片中没有找到确切时间，请为此日程选择时间。',
        doseLabelTemplate: '第{n}次',
        confirmButton: '确认并保存',
        cancelButton: '取消',
      },
    ...
    review: {
      ...
      demo: {
        ...
        contactNote: '由 Snapsist 演示创建的联系人。',
        mailSubjectDefault: 'Snapsist 演示邮件',
        mailBodyFormat: 'HTML 格式（isHtml: true）',
        mailBodyContent: '这是 <b>Snapsist</b> 自动填写的邮件草稿。',
        ...
        filesContentPrefix: 'Snapsist 演示文件\n创建时间: ',
        filesShareDialogTitle: '保存 Snapsist 文件',
        filesDetail: '已保存到文档目录',
        walletDescriptionDefault: 'Snapsist 演示卡券',
        walletShareDialogTitle: '添加到 Apple Wallet',
        walletDetail: 'Apple Wallet 分享面板已打开',
        notificationTitleTemplate: 'Snapsist / {text}',
        notificationSubtitleDefault: '演示通知',
        notificationBody: '此通知预定在 5 秒后送达，用于演示所有参数。',
    ...
    batch: {
      ...
      categoryLabels: categoryLabels(['名片', '收据', '活动', '文件', '用药提醒', '未知']),
      actionContact: '→ 通讯录',
      actionCalendar: '→ 日历',
      actionNote: '→ 分享到备忘录',
      actionSkip: '→ 已跳过',
  ...
  fr: {
    ...
    home: {
      ...
      medicationDosage: 'Dosage',
      medicationFrequencyTemplate: '{n} fois par jour',
      medicationDurationTemplate: 'Traitement de {n} jours',
      medicationTimingBeforeMeal: 'Avant les repas',
      medicationTimingAfterMeal: 'Après les repas',
      medicationTimingWithMeal: 'Avec les repas',
      medicationTimingUnspecified: 'Horaire non précisé',
      saveToContacts: 'Enregistrer dans Contacts',
      saveToCalendar: 'Enregistrer dans Calendrier',
      saveToReminder: 'Configurer les rappels',
      ...
      saveReminderDoneBodyTemplate: 'Rappels quotidiens configurés pour {n} jours.',
      saveFailTitle: 'Échec de l’enregistrement',
      timeConfirm: {
        title: 'Confirmer l’heure du rappel',
        subtitleMedication: 'Aucune heure exacte trouvée sur l’étiquette — choisissez quand être rappelé.',
        subtitleEvent: 'Aucune heure exacte trouvée sur la photo — choisissez une heure pour cet événement.',
        doseLabelTemplate: 'Prise {n}',
    ...
    review: {
      ...
      demo: {
        ...
        contactNote: 'Contact créé par la démo Snapsist.',
        mailSubjectDefault: 'E-mail démo Snapsist',
        mailBodyFormat: 'Format HTML (isHtml: true)',
        mailBodyContent: '<b>Snapsist</b> a rempli automatiquement ce brouillon d’e-mail.',
        ...
        filesContentPrefix: 'Fichier démo Snapsist\nCréé le : ',
        filesShareDialogTitle: 'Enregistrer le fichier Snapsist',
        filesDetail: 'Enregistré dans le répertoire des documents',
        walletDescriptionDefault: 'Carte démo Snapsist',
        walletShareDialogTitle: 'Ajouter à Apple Wallet',
        walletDetail: 'Feuille de partage Apple Wallet ouverte',
        notificationTitleTemplate: 'Snapsist / {text}',
        notificationSubtitleDefault: 'notification démo',
        notificationBody: 'Cette notification est programmée pour arriver dans 5 secondes afin de démontrer tous les paramètres.',
    ...
    batch: {
      ...
      categoryLabels: categoryLabels(['Carte de visite', 'Reçu', 'Événement', 'Document', 'Médicament', 'Inconnu']),
      actionContact: '→ Contacts',
  ...
  de: {
    ...
    home: {
      ...
      medicationFrequencyTemplate: '{n}x täglich',
      medicationDurationTemplate: '{n}-tägige Einnahme',
      medicationTimingBeforeMeal: 'Vor den Mahlzeiten',
      medicationTimingAfterMeal: 'Nach den Mahlzeiten',
      medicationTimingWithMeal: 'Zu den Mahlzeiten',
      medicationTimingUnspecified: 'Keine Zeit angegeben',
      saveToContacts: 'In Kontakten speichern',
      saveToCalendar: 'Im Kalender speichern',
      saveToReminder: 'Erinnerungen einrichten',
      ...
      saveReminderDoneBodyTemplate: 'Tägliche Erinnerungen für {n} Tage eingerichtet.',
      saveFailTitle: 'Speichern fehlgeschlagen',
      timeConfirm: {
        title: 'Erinnerungszeit bestätigen',
        subtitleMedication: 'Auf dem Etikett wurde keine genaue Uhrzeit gefunden — wähle, wann erinnert werden soll.',
        subtitleEvent: 'Auf dem Foto wurde keine genaue Uhrzeit gefunden — wähle eine Uhrzeit für diesen Termin.',
        doseLabelTemplate: 'Einnahme {n}',
        confirmButton: 'Bestätigen & speichern',
    ...
    review: {
      ...
      demo: {
        ...
        photoDetailTemplate: 'Album: {album}',
        photoOriginalFile: 'Demo-PNG (1×1)',
        contactNote: 'Von der Snapsist-Demo erstellter Kontakt.',
        mailSubjectDefault: 'Snapsist-Demo-E-Mail',
        mailBodyFormat: 'HTML-Format (isHtml: true)',
        mailBodyContent: '<b>Snapsist</b> hat diesen E-Mail-Entwurf automatisch ausgefüllt.',
        mailDetailTemplate: 'Status: {status}',
        smsMessageDefault: 'Dies ist eine Snapsist-Demo-SMS.',
        smsDetailTemplate: 'Status: {status}',
        filesSaveLocation: 'Dokumentenverzeichnis (Paths.document)',
        filesContentPrefix: 'Snapsist-Demo-Datei\nErstellt: ',
        filesShareDialogTitle: 'Snapsist-Datei speichern',
        filesDetail: 'Im Dokumentenverzeichnis gespeichert',
        walletDescriptionDefault: 'Snapsist-Demo-Pass',
        walletShareDialogTitle: 'Zu Apple Wallet hinzufügen',
        walletDetail: 'Apple-Wallet-Freigabemenü geöffnet',
        notificationTitleTemplate: 'Snapsist / {text}',
        notificationSubtitleDefault: 'Demo-Benachrichtigung',
        notificationBody: 'Diese Benachrichtigung ist so geplant, dass sie in 5 Sekunden eintrifft, um alle Parameter zu demonstrieren.',
    ...
    batch: {
      ...
      categoryLabels: categoryLabels(['Visitenkarte', 'Beleg', 'Termin', 'Dokument', 'Medikament', 'Unbekannt']),
