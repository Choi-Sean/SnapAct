...
const ENTRIES: Entry[] = [
  ...
  },
  {
    ...
    time: '1d',
    fields: [
      { labelKo: '할 일', labelEn: 'Task', value: 'Buy milk' },
      { labelKo: '마감', labelEn: 'Due', value: 'Today' },
    ],
  },
  {
    id: 'wallet',
    icon: 'wallet',
    titleKo: 'Event Ticket',
    ...
    time: '2d',
    fields: [
      { labelKo: '종류', labelEn: 'Type', value: 'Event Ticket' },
      { labelKo: '소유자', labelEn: 'Holder', value: 'Jane Doe' },
    ],
  },
];
